 ...
 * Controller for ...
 */
public class CLMDebitMemoCO extends OAControllerImpl
{
...
//  bwReqid                 =   pageContext.getParameter("bwReqId");
    ...
    am.invokeMethod("executDebitMemoVO",new Serializable[]{clmid,poNo} );
    am.invokeMethod("executDebitHistVO",new Serializable[]{clmid,poNo} );
    
    am.executDebitMemoVO(clmid,poNo);
    am.executDebitHistVO(clmid,poNo);
    
    String errflag  =   (String) am.invokeMethod("setDebitMemoValues");
...
//  am.invokeMethod("HandlePPR");
   ...
   */
   public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
   {
    ...
    CLMPaymentAMImpl    am  =   (CLMPaymentAMImpl)pageContext.getApplicationModule(webBean);  
    OAViewObject        vo  =   (OAViewObject)am.getCLMPaymentInvoiceEOVO2();
...
//          poNo    =   rowi.getPoNumber();   
            ...
            {                        
                throw new OAException("Please Enter Debit Amount",OAException.ERROR);              
            }
...
//              Matcher hasLetter   =   letter.matcher(password);
                ...
                {
                    throw new OAException("Invoice Amount Exceeds Debit Amount ",OAException.ERROR);
                }
            }
            rowi.setInvoiceWfStatus("Submitted");
            rowi.setSaveFlag("N");
            rowi.setInvoiceStatus("New");
            clmInvNO    =   "DN_"+am.getOADBTransaction().getSequenceValue("xxsify_clm_pay_debit_s");
            rowi.setClmInvoiceNumber(clmInvNO);
        ...
        OAException     confirmMessage  =  new OAException("The Debit Invoice Number "+clmInvNO +" for the CLM ID "+clmid+" submitted for approval");
